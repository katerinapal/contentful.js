...
test('API call getSpace fails', t => {
  return Promise.resolve().then(function () {
    ...
    return api.getSpace('spaceid').then(() => {}, r => {
      t.looseEqual(r, data);
      teardown();
    });
  });
...
test('API call getContentType fails', t => {
  return Promise.resolve().then(function () {
    ...
    return api.getContentType('ctid').then(() => {}, r => {
      t.looseEqual(r, data);
      teardown();
    });
  });
...
test('API call getContentTypes fails', t => {
  return Promise.resolve().then(function () {
    ...
    return api.getContentTypes().then(() => {}, r => {
      t.looseEqual(r, data);
      teardown();
    });
  });
...
test('API call getEntry fails', t => {
  return Promise.resolve().then(function () {
    ...
    return api.getEntry('eid').then(() => {}, r => {
      t.looseEqual(r, data);
      teardown();
    });
  });
...
test('API call getAsset fails', t => {
  return Promise.resolve().then(function () {
    ...
    return api.getAsset('aid').then(() => {}, r => {
      t.looseEqual(r, data);
      teardown();
    });
  });
...
test('CDA call sync fails', t => {
  return Promise.resolve().then(function () {
    ...
    return api.sync({ initial: true }).then(() => {}, r => {
