...
export default function createContentfulApi({ http, getGlobalOptions }) {
  ...
  function getSpace() {
    return Promise.resolve().then(function () {
      ...
      return Promise.resolve().then(function () {
        ...
        return errorHandler(generatedVariable0);
      });
    }).then(function () {
  ...
  function getEntry(id, query = {}) {
    ...
    return Promise.resolve().then(function () {
      ...
      return Promise.resolve().then(function () {
        return _this4.getEntries(_extends({ 'sys.id': id }, query));
      }).then(function (_resp) {
        response = _resp;
      }).catch(function (catchVar) {
        return errorHandler(generatedVariable0);
  ...
  function sync(query = {}, options = { paginate: true }) {
    const { resolveLinks, removeUnresolved } = getGlobalOptions(query);
    switchToEnvironment(http);
    return pagedSync(http, query, _extends({ resolveLinks, removeUnresolved }, options));
  }
