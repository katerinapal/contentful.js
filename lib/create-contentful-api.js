...
export default function createContentfulApi ({http, getGlobalOptions}) {
  ...
  async function getSpace() {
    ...
    try {
      ...
      return await errorHandler(generatedVariable0);
    }

    return await wrapSpace(response.data);
  }
  ...
  async function getContentType(id) {
    ...
    try {
      response = await http.get('content_types/' + id);
    } catch (catchVar) {
      return await errorHandler(generatedVariable0);
    }

    return await wrapContentType(response.data);
  }
  ...
  async function getContentTypes(query = {}) {
    ...
    try {
      response = await http.get('content_types', createRequestConfig({query: query}));
    } catch (catchVar) {
      return await errorHandler(generatedVariable0);
    }

    return await wrapContentTypeCollection(response.data);
  }
  ...
  async function getEntry(id, query = {}) {
    ...
    try {
      response = await this.getEntries({'sys.id': id, ...query});
    } catch (catchVar) {
      return await errorHandler(generatedVariable0);
    }
  ...
  async function getEntries(query = {}) {
    ...
    try {
      response = await http.get('entries', createRequestConfig({query: query}));
    } catch (catchVar) {
      return await errorHandler(generatedVariable0);
    }

    return await wrapEntryCollection(response.data, { resolveLinks, removeUnresolved });
  }
  /**
   * Gets an Asset
   * @memberof ContentfulClientAPI
  ...
  async function getAsset(id, query = {}) {
    ...
    try {
      response = await http.get('assets/' + id, createRequestConfig({query: query}));
    } catch (catchVar) {
      return await errorHandler(generatedVariable0);
    }

    return await wrapAsset(response.data);
  }
  ...
  async function getAssets(query = {}) {
    ...
    try {
      response = await http.get('assets', createRequestConfig({query: query}));
    } catch (catchVar) {
      return await errorHandler(generatedVariable0);
    }

    return await wrapAssetCollection(response.data);
  }
  ...
  async function getLocales(query = {}) {
    ...
    try {
      response = await http.get('locales', createRequestConfig({query: query}));
    } catch (catchVar) {
      return await errorHandler(generatedVariable0);
    }

    return await wrapLocaleCollection(response.data);
  }
